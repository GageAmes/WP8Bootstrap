namespace WP8Bootstrap.Converters
{
    using System;
    ...
    // Source:  http://rachel53461.wordpress.com/2011/08/20/the-math-converter/
        ...
        private void EvaluateMathString(ref string mathEquation, ref List<double> numbers, int index)
        {
            ...
            while (token != string.Empty)
            {
                ...
                if (_operators.Contains(token))
                {
                    ...
                    string nextToken = this.GetNextToken(mathEquation);
                    if (nextToken == "(")
                    {
                ...
                token = this.GetNextToken(mathEquation);
            }
        }
